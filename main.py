...
class AirTravelApp(ctk.CTk):
    def __init__(self):
        ...
        self.create_layout()
        if self.is_admin:
            self.users_button = ctk.CTkButton(self.sidebar_frame, text="Usuários", command=self.manage_users)
    ...
    def create_layout(self):
        ...
        self.flights_button = ctk.CTkButton(self.sidebar_frame, text="Voos", command=self.show_flights)
        self.flights_button.pack(pady=10, padx=20, fill="x")
        
        self.booking_button = ctk.CTkButton(self.sidebar_frame, text="Reservas", command=self.show_bookings)
        self.booking_button.pack(pady=10, padx=20, fill="x")
        
        self.reports_button = ctk.CTkButton(self.sidebar_frame, text="Relatórios", command=self.show_reports)
        self.reports_button.pack(pady=10, padx=20, fill="x")
        
        self.settings_button = ctk.CTkButton(self.sidebar_frame, text="Configurações", command=self.show_settings)
        self.settings_button.pack(pady=10, padx=20, fill="x")
        
        # Botão de logout no final do sidebar
        self.logout_button = ctk.CTkButton(self.sidebar_frame, text="Sair", fg_color="transparent", 
    ...
    def show_login_frame(self):
        ...
        # Botão de login
        login_button = ctk.CTkButton(login_content, text="Entrar", width=340, command=self.perform_login)
        ...
        register_button = ctk.CTkButton(login_content, text="Registrar", width=340, 
    ...
    def show_register_frame(self):
        ...
        ctk.CTkButton(btn_frame, text="Cancelar", command=register_window.destroy).pack(side="left", padx=10)
        ctk.CTkButton(btn_frame, text="Registrar", command=self.perform_register).pack(side="right", padx=10)
    ...
    def show_flights(self):
        ...
        add_button = ctk.CTkButton(actions_frame, text="Adicionar Voo", width=150, command=self.add_flight)
        if self.is_admin:
        ...
        search_button = ctk.CTkButton(actions_frame, text="Buscar", width=100)
    ...
    def add_flight(self):
        ...
        cancel_button = ctk.CTkButton(button_frame, text="Cancelar", width=100, fg_color="transparent", 
                                    border_width=2, text_color=("gray10", "gray90"),
                                    command=lambda: add_window.destroy())
        cancel_button.pack(side="left", padx=10, pady=10)
        
        save_button = ctk.CTkButton(button_frame, text="Salvar", width=100, 
